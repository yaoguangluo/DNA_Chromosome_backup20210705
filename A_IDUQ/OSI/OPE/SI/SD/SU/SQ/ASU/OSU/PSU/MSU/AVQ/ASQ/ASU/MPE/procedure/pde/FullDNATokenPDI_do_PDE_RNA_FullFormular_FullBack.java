...
//分出fullback函数.缩小java文件体积.大家要看清楚,这不是osgi函数去重,不是sonar语法纠正.这是java大文件逐渐裁剪.
...
//	public void doKeyPress(String initons, FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular, boolean bYS) {	
...
//		return string;
//	}
//	private void deSecCode(FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular, boolean b) {
//		//
...
//	}
//
//	private void de_PDE_RNA_FullFormularForDB(Initon initon, FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular, boolean bYS) {
...
//	}
//
//	private void enSecCode(FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular, boolean bys) {
//		String initons= pDE_RNA_FullFormular.code;
//		Initon[] initon= new Initon[initons.length()];
//		for(int i= 0; i< initons.length(); i++) {
//			if(initon[i]== null) {
...
////	}
//
//	public void doFullSessionKeyUnPress(String initons, FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular3, boolean bYS) {
//		Initon[] initon= new Initon[initons.length()];
//		for(int i= 0; i< initons.length(); i++) {
//			if(initon[i]== null) {
//				initon[i]= new Initon();
...
//	}
	...
	private void do_PDE_RNA_FullFormular_FullBack(Initon initon, FullDNATokenPDI pDE_RNA_FullFormular3
		...
		Initon InitonPDE= initon; 
		InitonLinkDNA initonLinkDNA= new InitonLinkDNA();
		Initon InitonPDE1V= new FullDNATokenPDI().doIncrementV(InitonPDE, initonLinkDNA, pDE_RNA_FullFormular3);	
		Initon InitonPDE1E= new FullDNATokenPDI().doIncrementE(InitonPDE1V, initonLinkDNA, pDE_RNA_FullFormular3, bYS);
		Initon InitonPDE1C= new FullDNATokenPDI().doIncrementC(InitonPDE1E, initonLinkDNA, pDE_RNA_FullFormular3);	
		Initon InitonPDE1S= new FullDNATokenPDI().doIncrementS(InitonPDE1C, initonLinkDNA, pDE_RNA_FullFormular3, bYS);
		
		Initon InitonPDE1A= new FullDNATokenPDI().doIncrementA(InitonPDE1S, initonLinkDNA, pDE_RNA_FullFormular3);	
		Initon InitonPDE1O= new FullDNATokenPDI().doIncrementO(InitonPDE1A, initonLinkDNA, pDE_RNA_FullFormular3);
		Initon InitonPDE1P= new FullDNATokenPDI().doIncrementP(InitonPDE1O, initonLinkDNA, pDE_RNA_FullFormular3); 
		Initon InitonPDE2= new FullDNATokenPDI().doIncrementM(InitonPDE1P, initonLinkDNA, pDE_RNA_FullFormular3);
		...
		Initon InitonPDEM= new FullDNATokenPDI().doDecrementM(InitonPDE2, initonLinkDNA, pDE_RNA_FullFormular3);
		Initon InitonPDEP= new FullDNATokenPDI().doDecrementP(InitonPDEM, initonLinkDNA, pDE_RNA_FullFormular3);
		Initon InitonPDEO= new FullDNATokenPDI().doDecrementO(InitonPDEP, initonLinkDNA, pDE_RNA_FullFormular3);
		Initon InitonPDEA= new FullDNATokenPDI().doDecrementA(InitonPDEO, initonLinkDNA, pDE_RNA_FullFormular3);

		Initon InitonPDES= new FullDNATokenPDI().doDecrementS(InitonPDEA, initonLinkDNA, pDE_RNA_FullFormular3, bYS);
		Initon InitonPDEC= new FullDNATokenPDI().doDecrementC(InitonPDES, initonLinkDNA, pDE_RNA_FullFormular3);	
		Initon InitonPDEE= new FullDNATokenPDI().doDecrementE(InitonPDEC, initonLinkDNA, pDE_RNA_FullFormular3, bYS);
		Initon InitonPDE1= new FullDNATokenPDI().doDecrementV(InitonPDEE, initonLinkDNA, pDE_RNA_FullFormular3); 
		while(InitonPDE1.hasNext()) { 
...
//	public void doSessionKeyUnPress(String initons, FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular2, boolean bYS) {
//		Initon[] initon= new Initon[initons.length()];
//		for(int i= 0; i< initons.length(); i++) {
//			if(initon[i]== null) {
//				initon[i]= new Initon();
...
//	}
	...
	private void do_PDE_RNA_FullFormular_Back(Initon initon, FullDNATokenPDI pDE_RNA_FullFormular
		...
		Initon InitonPDE= initon; 
		InitonLinkDNA initonLinkDNA= new InitonLinkDNA();
		Initon InitonPDEM= new FullDNATokenPDI().doDecrementM(InitonPDE, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDEP= new FullDNATokenPDI().doDecrementP(InitonPDEM, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDEO= new FullDNATokenPDI().doDecrementO(InitonPDEP, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDEA= new FullDNATokenPDI().doDecrementA(InitonPDEO, initonLinkDNA, pDE_RNA_FullFormular);

		Initon InitonPDES= new FullDNATokenPDI().doDecrementS(InitonPDEA, initonLinkDNA, pDE_RNA_FullFormular, bYS);
		Initon InitonPDEC= new FullDNATokenPDI().doDecrementC(InitonPDES, initonLinkDNA, pDE_RNA_FullFormular);	
		Initon InitonPDEE= new FullDNATokenPDI().doDecrementE(InitonPDEC, initonLinkDNA, pDE_RNA_FullFormular, bYS);
		Initon InitonPDE1= new FullDNATokenPDI().doDecrementV(InitonPDEE, initonLinkDNA, pDE_RNA_FullFormular); 
		while(InitonPDE1.hasNext()) { 
			pDE_RNA_FullFormular.pds+= InitonPDE1.getStore();
			InitonPDE1= InitonPDE1.next;
		} 
...
//	public void doKeyUnPress(String initons, FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular, boolean bYS) {
//		Initon[] initon= new Initon[initons.length()];
//		for(int i= 0; i< initons.length(); i++) {
//			if(initon[i]== null) {
//				initon[i]= new Initon();
...
//	}
//
//	private void do_PDE_RNA_FullFormularForDB(Initon initon, FullDNATokenPDI_do_PDE_RNA_FullFormular_FullBack pDE_RNA_FullFormular, boolean bYS) {
//		// TODO Auto-generated method stub
//		Initon InitonPDE= initon; 
//		InitonLinkDNA initonLinkDNA= new InitonLinkDNA();
...
//	}
	...
	public void do_PDE_RNA_FullFormular(Initon initon, FullDNATokenPDI pDE_RNA_FullFormular
		...
		InitonLinkDNA initonLinkDNA= new InitonLinkDNA();
		//a->b
		Initon InitonPDEA= new FullDNATokenPDI().doDecrementA(InitonPDE, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDEO= new FullDNATokenPDI().doDecrementO(InitonPDEA, initonLinkDNA, pDE_RNA_FullFormular);	
		Initon InitonPDEP= new FullDNATokenPDI().doDecrementP(InitonPDEO, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDEM= new FullDNATokenPDI().doDecrementM(InitonPDEP, initonLinkDNA, pDE_RNA_FullFormular); 
		Initon InitonPDEV= new FullDNATokenPDI().doDecrementV(InitonPDEM, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDEE= new FullDNATokenPDI().doDecrementE(InitonPDEV, initonLinkDNA, pDE_RNA_FullFormular, bYS);
		Initon InitonPDEC= new FullDNATokenPDI().doDecrementC(InitonPDEE, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDE1= new FullDNATokenPDI().doDecrementS(InitonPDEC, initonLinkDNA, pDE_RNA_FullFormular, bYS);
		while(InitonPDE1.hasNext()) { 
			pDE_RNA_FullFormular.pds+= InitonPDE1.getStore();
			InitonPDE1= InitonPDE1.next;
		} 
		...
		//b->c
		Initon InitonPDE1V= new FullDNATokenPDI().doIncrementV(InitonPDE1, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDE1E= new FullDNATokenPDI().doIncrementE(InitonPDE1V, initonLinkDNA, pDE_RNA_FullFormular, bYS);
		Initon InitonPDE1C= new FullDNATokenPDI().doIncrementC(InitonPDE1E, initonLinkDNA, pDE_RNA_FullFormular);		
		Initon InitonPDE1S= new FullDNATokenPDI().doIncrementS(InitonPDE1C, initonLinkDNA, pDE_RNA_FullFormular, bYS);
		Initon InitonPDE1A= new FullDNATokenPDI().doIncrementA(InitonPDE1S, initonLinkDNA, pDE_RNA_FullFormular);	
		Initon InitonPDE1O= new FullDNATokenPDI().doIncrementO(InitonPDE1A, initonLinkDNA, pDE_RNA_FullFormular);
		Initon InitonPDE1P= new FullDNATokenPDI().doIncrementP(InitonPDE1O, initonLinkDNA, pDE_RNA_FullFormular); 
		Initon InitonPDE2= new FullDNATokenPDI().doIncrementM(InitonPDE1P, initonLinkDNA, pDE_RNA_FullFormular);
		while(InitonPDE2.hasNext()) { 
			pDE_RNA_FullFormular.pde+= InitonPDE2.getStore();
			InitonPDE2= InitonPDE2.next;
		} 
