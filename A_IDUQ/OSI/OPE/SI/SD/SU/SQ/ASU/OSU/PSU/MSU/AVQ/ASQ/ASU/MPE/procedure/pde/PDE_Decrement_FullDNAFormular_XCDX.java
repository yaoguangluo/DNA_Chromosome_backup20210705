...
public class PDE_Decrement_FullDNAFormular_XCDX {
	...
	public Initon PDE_DecrementE_DU(InitonLinkDNA initonLinkDNA, FullDNATokenPDI_XCDX pDE_RNA_Formular, boolean bYS) {
		Initon initonLink= initonLinkDNA.getInitonLink();
		int index= 0;
		while(null!= initonLink) {
	...
	public Initon PDE_DecrementS_IQ(InitonLinkDNA initonLinkDNA, FullDNATokenPDI_XCDX pDE_RNA_Formular, boolean bYS) {
		Initon initonLink= initonLinkDNA.getInitonLink();
		int index= 0;
		while(null!= initonLink) {
