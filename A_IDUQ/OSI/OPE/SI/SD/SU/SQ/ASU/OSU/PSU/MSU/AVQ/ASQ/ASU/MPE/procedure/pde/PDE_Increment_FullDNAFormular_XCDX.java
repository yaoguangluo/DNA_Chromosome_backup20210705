...
public class PDE_Increment_FullDNAFormular_XCDX {
	...
	public Initon PDE_IncrementE_DU(InitonLinkDNA initonLinkDNA, FullDNATokenPDI_XCDX pDE_RNA_Formular, boolean bYS) {
		Initon initonLink= initonLinkDNA.getInitonLink();
		while(null!= initonLink) {
	...
	public Initon PDE_IncrementS_IQ(InitonLinkDNA initonLinkDNA, FullDNATokenPDI_XCDX pDE_RNA_Formular) {
		Initon initonLink= initonLinkDNA.getInitonLink();
		//int index= 0;
		while(null!= initonLink) {
			String initonString= initonLink.getStore();
