				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("名")) {
								page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(255, 245, 255)+"\"><font color=\"black\" size=\"5\">"  + setOfi +split+
										 (ctr.containsKey(setOfi)? ctr.get(setOfi):"")+splite  +  "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("动")) {
				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("名")) {
								page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(255, 245, 255)+"\"><font color=\"black\" size=\"5\">"  + setOfi +
										 (pinyin.containsKey(setOfi)? pinyin.get(setOfi):"") +  "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("动")) {
								page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(245, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +
										 (pinyin.containsKey(setOfi)? pinyin.get(setOfi):"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("形")) {
								page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(255, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +
										 (pinyin.containsKey(setOfi)? pinyin.get(setOfi):"") + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("副")) {
				...
				Here:
					while(iterator.hasNext()) {
						...
						if (!setOfi.equals("")) {
							...
							if(pos.get(setOfi).contains("动")) {
								page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(145, 255, 145)+"\"><font color=\"black\" size=\"5\">" + setOfi + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("形")) {
								page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(255, 255, 145)+"\"><font color=\"black\" size=\"5\">" + setOfi + "</font></span>");
								continue Here;
							}
							if(pos.get(setOfi).contains("副")) {
