...
public class Dictionary{	
	...
	public List<String> txtToListName() throws IOException{
		...
		TEMP_list.add(StableFile.傅青主女科歌括_清_傅山_txt);
		TEMP_list.add(StableFile.保婴撮要_明_薛铠_txt);
		TEMP_list.add(StableFile.保幼新编_清_卢光履_txt);
		TEMP_list.add(StableFile.慈幼便览_清_佚名_txt);
		TEMP_list.add(StableFile.儿科萃精__陈守真_txt);
		TEMP_list.add(StableFile.妇科百辩_明_庄履严_txt);
		TEMP_list.add(StableFile.妇科秘书___txt);
		TEMP_list.add(StableFile.妇科玉尺_清_沈金鳌_txt);
		TEMP_list.add(StableFile.妇人良方集要_宋_陈自明_txt);
		TEMP_list.add(StableFile.傅青主女科_明_傅山_txt); 
		TEMP_list.add(StableFile.傅青主男科重编考释_明_傅山_txt); 
		return TEMP_list;
	}
		...
		for(int i = 0; i < dic_list.size(); i++) {
			...
			if(name.equalsIgnoreCase(StableFile.保婴撮要_明_薛铠_txt) 
					|| name.equalsIgnoreCase(StableFile.慈幼便览_清_佚名_txt)
							|| name.equalsIgnoreCase(StableFile.傅青主女科歌括_清_傅山_txt)) {
