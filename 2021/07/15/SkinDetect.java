...
public class SkinDetect{
	...
	public static void main(String[] argv) throws IOException {
		...
		//double countYellow= ...
		double countYellow= new GetICAStatisticRatio(5, 15).getYellowStatisticCount(r, g, b);
		double countBlue= new GetICAStatisticRatio(5, 15).getBlueStatisticCount(r, g, b);
		double countRed= new GetICAStatisticRatio(5, 15).getRedStatisticCount(r, g, b);
		double countGreen= new GetICAStatisticRatio(5, 15).getGreenStatisticCount(r, g, b);
		double countPupil= new GetICAStatisticRatio(5, 15).getPupilStatisticCount(r, g, b);
		double countWhite= new GetICAStatisticRatio(5, 15).getWhiteStatisticCount(r, g, b);
		double countPink= new GetICAStatisticRatio(5, 15).getPinkStatisticCount(r, g, b);
		//double countPupil= ...
		//double countPink= ...
		//double countWhite= ...
