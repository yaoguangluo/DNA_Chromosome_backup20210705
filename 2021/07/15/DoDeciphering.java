...
public class DoDeciphering{
			...
			if(file.isFile()) {
				if(null!= file.getPath()) {
					...
					//if(filePath.contains(".png")) {
						...
						double[] getStatisticCount= new GetStatisticCount().getStatisticCount(doPDEofSkin, 10, 8, 10);
	...
	public static void main(String[] args) throws IOException {
		...
		doDeciphering.setOutputFilePath("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB4.txt");
