...
public class DoDesiphline{
	public String outputFilePath;
	public void setOutputFilePath(String outputPath) {
		outputFilePath= outputPath;
	} 
	public void imageDesiphline(String indexFileCategoryPath) throws IOException {
		//1 输入文件夹字符串
			...
			if(file.isFile()) {
				if(null!= file.getPath()) {
					...
					//if(filePath.contains(".png")) {
						...
						int[][][] doPDEofSkin= new DoPDEofSkin().doPDEofSkin(getSkinBy, 5);
	...
	public static void main(String[] args) throws IOException {
		DoDesiphline doDeciphering= new DoDesiphline();
		doDeciphering.setOutputFilePath("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB6.txt");
		doDeciphering.imageDesiphline("D:\\bu20210606\\搜索图片\\搜索图片\\pgSearch");
