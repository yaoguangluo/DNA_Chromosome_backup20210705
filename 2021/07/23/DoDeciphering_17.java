...
public class DoDeciphering_17{
			...
			if(file.isFile()) {
				if(null!= file.getPath()) {
					...
					//if(filePath.contains(".png")) {
						...
						int[][][] doPDEofSkin= new DoPDEofSkin().doPDEofSkin_AOPM_VECS_IDUQ_TXH(getSkinBy, 95);
						//new	ReadWritePng().writePNG("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB.jpg", doPDEofSkin);
						double[] getStatisticCount= new GetStatisticCount().getStatisticCount(doPDEofSkin, 10, 2, 8);
	...
	public static void main(String[] args) throws IOException {
		...
		doDeciphering.setOutputFilePath("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB6_17.txt");
