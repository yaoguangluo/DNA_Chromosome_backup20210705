...
public class JzkxPage extends Container implements MouseListener, KeyListener{
	...
	protected int row;
	public JzkxPage(JTextPane text, CogsBinaryForest_AE _A, Map<String, String> pos, Map<String, String> pose
	...
	public JTextPane data() throws IOException {
		...
		buttonKSLJ.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				StringBuilder page = new StringBuilder().append("");
				AppButtonUtil.page中药DNN(page, sets, currentPage, u, table, row, pos, key
	...
	public void keyReleased(KeyEvent arg0) {
		...
		int count= AppSearch.detaSearch(score_code, score, newTableModel, tableData_old, copy, key
				, dic_map, pos, this.u, true);//测试了下，OK， 准备整体vpcs替换。之后设计成线程。避免搜索死锁，
		if(-1== count) {
			return;
		}
