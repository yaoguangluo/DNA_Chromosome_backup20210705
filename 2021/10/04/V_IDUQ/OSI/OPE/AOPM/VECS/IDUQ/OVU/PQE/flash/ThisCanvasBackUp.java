			...
			while(node!= null){
				...
				if(node.beconnect){
					if(node.tBeconnect){
						...
						if(node.actionNodeLeft) {
							graphics2D.setColor(new Color(240, 240, 240));
							drawArrow.doDrawArrow(graphics2D, node.tBeconnectX+ 62
									, node.tBeconnectY+ 28
						...
						if(node.tNode.actionNodeLeft) {
							...
							drawArrow.doDrawArrow(graphics2D, node.tBeconnectX+ 62
									...
									, node.x+ 14, node.y- 6);
							graphics2D.setColor(new	Color(25, 25, 112));
							drawArrow.doDrawArrow(graphics2D, node.tNode.x+ 62
									, node.tNode.y+ 28
									, node.x+ 14, node.y- 6);
						...
						if(!node.leftChoose&& node.rightChoose){
							...
							graphics2D.setColor(Color.black);
							drawArrow.doDrawArrow(graphics2D, oldX, oldY, currentX
									, currentY);
							graphics2D.setColor(new	Color(25, 25, 112));	
						}
					}if(node.mBeconnect){
						if(node.actionNodeLeft) {
							graphics2D.setColor(new Color(240, 240, 240));
							drawArrow.doDrawArrow(graphics2D, node.mBeconnectX+ 62
									, node.mBeconnectY+ 28
						...
						if(node.mNode.actionNodeLeft) {
							...
							drawArrow.doDrawArrow(graphics2D, node.mBeconnectX+ 62
									...
									, node.x- 4, node.y+ 25);
							graphics2D.setColor(new	Color(25, 25, 112));
							drawArrow.doDrawArrow(graphics2D,  node.mNode.x+ 62
									, node.mNode.y+ 28
									, node.x- 4, node.y+ 25);
						...
						if(node.actionNodeLeft) {
							graphics2D.setColor(new Color(240, 240, 240));
							drawArrow.doDrawArrow(graphics2D, node.dBeconnectX+ 62
									, node.dBeconnectY+ 28
						...
						if(node.dNode.actionNodeLeft) {
							...
							drawArrow.doDrawArrow(graphics2D, node.dBeconnectX+ 62
									...
									, node.oldx+ 6, node.oldy+ 55);
							graphics2D.setColor(new	Color(25, 25, 112));
							drawArrow.doDrawArrow(graphics2D,  node.dNode.x+ 62
									, node.dNode.y+ 28
									, node.x+ 6, node.y+ 55);
