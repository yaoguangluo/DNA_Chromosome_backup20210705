...
//import OSI.OSU.SI.OVI.OSI.AVI.AEI.ACI.ASI.OVI.OEI.OCI.OSI.PVI.PEI.PCI.PSI.addZNSZPage.AddZNSZPageNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI;
...
//		
		...
		u.gUISample.nodeReflection.put(OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI.SQ_OSU_MSQ_OSU_AVQ_ASQ_SQ_VPC_PCS, null);
		OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI.register(u.gUISample.tableData_old, u.gUISample.text
...
//add extp//////
//		//声诊断,该接口已经2年停止开源研发。
//		OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI soundCheck = new AddZNSZPageNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI();
...
//		u.searchList.add(soundCheck);
		...
		OSU_AVQ_ASQ_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI tinShell = new AddTinShellNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI();
