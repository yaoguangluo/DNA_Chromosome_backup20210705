...
public class XA_ShellTables{
	...
	public static boolean addInitSearchShellTable(App app) {
		...
		addNewSearchShellTable("中医方剂", app.zynkxPage.tableData_old, app.zynkxPage.columnTitle);
		...
		addNewSearchShellTable("中医外伤", app.wskxPage.tableData_old, app.wskxPage.columnTitle);
		...
		addNewSearchShellTable("哈里森", app.cecil.tableData_old, app.cecil.columnTitle);
		//上面是主页面，
