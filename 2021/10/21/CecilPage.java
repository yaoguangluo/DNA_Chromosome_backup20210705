			...
			Here:
				while(iterator.hasNext()) {
					...
					if (!setOfi.equals("")) {
						...
						if(pecsi.contains("名")) {
							page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(255, 245, 255)+"\"><font color=\"black\" size=\"5\">" + setOfi +(posFullec.containsKey(setOfi)?":("+posFullec.get(setOfi)+")":"") + "</font></span>");
							continue Here;
						}
						if(pecsi.contains("动")) {
							page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(245, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +(posFullec.containsKey(setOfi)?":("+posFullec.get(setOfi)+")":"") + "</font></span>");
							continue Here;
						}
						if(pecsi.contains("形")) {
							page.append("<span style=\"background:"+new PEU.P.image.Color_P().P(255, 255, 245)+"\"><font color=\"black\" size=\"5\">" + setOfi +(posFullec.containsKey(setOfi)?":("+posFullec.get(setOfi)+")":"") + "</font></span>");
							continue Here;
						}
						if(pecsi.contains("副")) {
...
//						? (currentPage + 1)*2000: sets.size());
	...
	public void keyReleased(KeyEvent arg0) {
		...
		while(iteratorWordFrequency.hasNext()) {  
			...
			String mapSearchaAtII = iteratorWordFrequencyVerbal.getEnglish()==null
					?" ":iteratorWordFrequencyVerbal.getEnglish().replaceAll("\\s+", " ");
