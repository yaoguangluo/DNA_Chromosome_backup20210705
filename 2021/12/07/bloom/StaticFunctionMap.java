...
public class StaticFunctionMap{
	...
	public static void doO_VECS_CaseFunction(String callFunctionKey, String string, StaticFunctionMapO_VECS_E staticFunctionMapO_VECS_C, Map<String, Object> output) throws Exception {
		StaticFunctionMapO_VECS_C.callFunction(callFunctionKey, staticFunctionMapO_VECS_C, output);
	}
	public static void doO_IDUQ_CaseFunction(String callFunctionKey, String string, StaticFunctionMapO_IDUQ_E staticFunctionMapO_IDUQ_C, Map<String, Object> output) throws IOException, UnsupportedAudioFileException, InterruptedException, CloneNotSupportedException {
		StaticFunctionMapO_IDUQ_C.callFunction(callFunctionKey, staticFunctionMapO_IDUQ_C, output);
	}
	public static void doP_VECS_CaseFunction(String callFunctionKey, String string, StaticFunctionMapP_VECS_E staticFunctionMapP_VECS_C, Map<String, Object> output) throws IOException, InstantiationException, IllegalAccessException {
	...
	public static void doM_VECS_CaseFunction(String callFunctionKey, String string, StaticFunctionMapM_VECS_E staticFunctionMapM_VECS_C, Map<String, Object> output) throws Exception {
	...
	public static void doC_AOPM_CaseFunction(String callFunctionKey, String string, StaticFunctionMapC_AOPM_E staticFunctionMapC_AOPM_C, Map<String, Object> output) throws Exception {
	...
	public static void doS_AOPM_CaseFunction(String callFunctionKey, String string, StaticFunctionMapS_AOPM_E staticFunctionMapS_AOPM_C, Map<String, Object> output) throws Exception {
		StaticFunctionMapS_AOPM_C.callFunction(callFunctionKey, staticFunctionMapS_AOPM_C, output);
	}
	public static void doS_IDUQ_CaseFunction(String callFunctionKey, String string, StaticFunctionMapS_IDUQ_E staticFunctionMapS_IDUQ_C, Map<String, Object> output) throws IOException, CloneNotSupportedException {
		StaticFunctionMapS_IDUQ_C.callFunction(callFunctionKey, staticFunctionMapS_IDUQ_C, output);
	}
	public static void doI_AOPM_CaseFunction(String callFunctionKey, String string, StaticFunctionMapI_AOPM_E staticFunctionMapI_AOPM_C, Map<String, Object> output) throws IOException, HeadlessException, InterruptedException {
	...
	public static void doU_AOPM_CaseFunction(String callFunctionKey, String string, StaticFunctionMapU_AOPM_E staticFunctionMapU_AOPM_C, Map<String, Object> output) throws Exception {
