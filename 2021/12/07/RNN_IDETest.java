...
public class RNN_IDETest{
	...
	public String[][] getIDEMatrix(String text) throws IOException, InstantiationException, IllegalAccessException{
		this.text= text;
		return this.getIDEMatrix();
	}
	...
	public String[][] getIDEMatrix() throws IOException, InstantiationException, IllegalAccessException{
		...
		String[][] sensingMatrix = sensingTest.getMatrix(this.text);
	...
	public String[][] getIDEMatrixExclude_A(SensingTest sensingTest, String[][] ann, A _A, String string) {
		...
		while(mapIterator.hasNext()) {
			...
			ideMatrix[ideMatrixCount][0]= word;
			ideMatrix[ideMatrixCount][1]= StableCommon.STRING_EMPTY+ popFactor;
			ideMatrix[ideMatrixCount][2]= StableCommon.STRING_EMPTY+ dovFactor/ dovCount;// 平均distance数
			ideMatrix[ideMatrixCount][3]= StableCommon.STRING_EMPTY+ eopFactor;
			ideMatrixCount++;
		}
