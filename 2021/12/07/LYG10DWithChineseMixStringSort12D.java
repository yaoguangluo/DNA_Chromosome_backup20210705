...
public class LYG10DWithChineseMixStringSort12D{
	...
	public void quick4DChineseStringArray1D(String[] strings, int scale
		...
		lYG10DWCMSSort15D_XCDX_C_U_A.range= range;
		lYG10DWCMSSort15D_XCDX_C_U_A.deeps= deeps;
		lYG10DWCMSSort15D_XCDX_C_U_A.bihua= bihua;
		lYG10DWCMSSort15D_XCDX_C_U_A.processKernel(strings, 0, strings.length- 1, scale, 0);
	}
	...
	public void test() {
		try {
			...
			= new VerbalSource().getClass().getResourceAsStream(StableFile.PinYinCN_lyg);
    		BufferedReader cReaderp
    		= new BufferedReader(new InputStreamReader(inputStreamp, "GBK"));
    		//index
    		...
    		= new VerbalSource().getClass().getResourceAsStream(StableFile.BiHuaCN_lyg);
    		BufferedReader cReaderb
    		= new BufferedReader(new InputStreamReader(inputStreamb, "GBK"));
    		//index
