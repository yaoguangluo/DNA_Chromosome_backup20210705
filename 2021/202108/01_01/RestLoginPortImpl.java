...
import PCS.transaction.TransactionDelegateLogin;
...
//	private LoginService loginService;
	...
	public static Map<String, Object> login(String uEmail, String uPassword) throws Exception {
		Map<String, Object> map = TransactionDelegateLogin.transactionLogin(uEmail, uPassword);
		return map;
	}
	...
	public static Map<String, Object> register(String uEmail, String uEmailEnsure, String uName, String uPassword,
		...
		Map<String, Object> output = TransactionDelegateLogin.transactionRegisterDB_DNA(uEmail, uEmailEnsure, uName, uPassword,
