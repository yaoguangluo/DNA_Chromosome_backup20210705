...
//		initDeciphring("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB6_17.txt", 17);
	...
	///////////////////////////////////////////////////////////////////////////////////////////			
		...
		十六元酸性腐蚀训练文件地址.setBounds(10+ 0* 150, 20+ 25* 16, 150, 50);
		
		JTextField 十六元酸性腐蚀训练文件地址JTextField= new JTextField();
		十六元酸性腐蚀训练文件地址JTextField.setBounds(10+ 0* 150+ 160, 20+ 25* 16, 550, 50);
		...
		十六元碱性腐蚀训练文件地址.setBounds(10+ 0* 150, 20+ 25* 19, 150, 50);
		
		JTextField 十六元碱性腐蚀训练文件地址JTextField= new JTextField();
		十六元碱性腐蚀训练文件地址JTextField.setBounds(10+ 0* 150+ 160, 20+ 25* 19, 550, 50);
