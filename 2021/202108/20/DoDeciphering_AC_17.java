...
public class DoDeciphering_AC_17{
...
//					if(filePath.contains("阿洪病")) {
						//3 每个图片进行训练取值
						int[][][] getSkinBy= new GetSkinBy().getSkinBy(filePath);
						int[][][] doPDEofSkin= new DoPDEofSkin().doPDEofSkin_AOPM_VECS_IDUQ_TXH_AC(getSkinBy, 95);
//						new	ReadWritePng().writePNG("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB_20210820.jpg", doPDEofSkin);
						double[] getStatisticCount= new GetStatisticCount().getStatisticCount(doPDEofSkin, 10, 5, 8);
	...
	public static void main(String[] args) throws IOException {
		DoDeciphering_AC_17 doDeciphering= new DoDeciphering_AC_17();
		doDeciphering.setOutputFilePath("C:\\Users\\Lenovo\\Desktop\\deciphering\\F_DB6_suan_17.txt");
