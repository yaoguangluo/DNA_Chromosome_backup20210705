...
public class DoPDEofSkin{
	...
	public int[][][] doPDEofSkin_AOPM_VECS_IDUQ_TXH(int[][][] rgb, int ratio) {
		int[][][] output= new int[3][][];
		//int ratio= 50;
		int[][] rp= new RangePDI().IPE_AOPM_VECS_IDUQ_TXH(rgb[0], ratio);
		int[][] gp= new RangePDI().IPE_AOPM_VECS_IDUQ_TXH(rgb[1], ratio);
		int[][] bp= new RangePDI().IPE_AOPM_VECS_IDUQ_TXH(rgb[2], ratio); 
		output[0]= rp;
		output[1]= gp;
		output[2]= bp;
		return output;
	...
	public int[][][] doPDEofSkin_AOPM_VECS_IDUQ_TXH_AC(int[][][] rgb, int ratio) {
		int[][][] output= new int[3][][];
		//int ratio= 50;
		int[][] rp= new RangePDI().IPE_AOPM_VECS_IDUQ_TXH_AC(rgb[0], ratio);
		int[][] gp= new RangePDI().IPE_AOPM_VECS_IDUQ_TXH_AC(rgb[1], ratio);
		int[][] bp= new RangePDI().IPE_AOPM_VECS_IDUQ_TXH_AC(rgb[2], ratio); 
		output[0]= rp;
		output[1]= gp;
		output[2]= bp;
		return output;
