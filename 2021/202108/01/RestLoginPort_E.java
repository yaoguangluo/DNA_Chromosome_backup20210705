...
public class RestLoginPort_E {//implements RestLoginPort {
	...
	public static Map<String, Object> loginDB(String uEmail, String uPassword) throws Exception {
		Map<String, Object> map = TransactionDelegate.transactionLoginDB_DNA(uEmail, uPassword);
		return map;
	}
	...
	//分离出来方便之后继承 几天用dna代替登陆，准备研发和测试
	public static Map<String, Object> registerDB(String uEmail, String uEmailEnsure, String uName, String uPassword,
			String uPassWDEnsure, String uAddress, String uPhone, String uWeChat,
			String uQq, String uAge, String uSex) throws Exception {
		Map<String, Object> output = TransactionDelegate.transactionRegisterDB_DNA(uEmail, uEmailEnsure, uName, uPassword,
				uPassWDEnsure, uAddress, uPhone, uWeChat,
				uQq, uAge, uSex);
		return output;
	}
