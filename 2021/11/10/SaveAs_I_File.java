	...
	public static void Save(LinkNode first) {
		...
		try {
			...
			while(null!= node) {
				...
				Map<String, String> map= getRandomDNAkey(sessionValidation, StableToken.ETL_NODE_COORDINATION_X+ NodeCoordinationX);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_NODE_NAME+ NodeName);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_NODE_COORDINATION_Y+ NodeCoordinationY);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_NODE_ID+ NodeID);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_FLASH+ flash);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_BECONNECT+ beconnect);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_LEFT_CHOOSE+ leftChoose);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_RIGHT_CHOOSE+ rightChoose);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_TBECONNECT+ tBeconnect);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_TBECONNECT_X+ tBeconnectX);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_TBECONNECT_Y+ tBeconnectY);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_TBECONNECT_NAME+ tBeconnectName);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_TBECONNECT_ID+ tBeconnectID);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_TBECONNECT_PRIMARY_KEY+ tBeconnectPrimaryKey);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_MBECONNECT+ mBeconnect);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_MBECONNECT_X+ mBeconnectX);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_MBECONNECT_Y+ mBeconnectY);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_MBECONNECT_NAME+ mBeconnectName);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_MBECONNECT_ID+ mBeconnectID);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_MBECONNECT_PRIMARY_KEY+ mBeconnectPrimaryKey);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_DBECONNECT+ dBeconnect);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_DBECONNECT_X+ dBeconnectX);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_DBECONNECT_Y+ dBeconnectY);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_DBECONNECT_NAME+ dBeconnectName);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_DBECONNECT_ID+ dBeconnectID);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_DBECONNECT_PRIMARY_KEY+ dBeconnectPrimaryKey);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_PRIMARY_KEY+ primaryKey);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_NODE_CONFIGURATION+ nodeConfiguration);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_ISCONFIGED+ isConfiged);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));

				fileWriter.write(StableToken.LINE_ENTER);
				fileWriterKey.write(StableToken.LINE_ENTER);
				map= getRandomDNAkey(sessionValidation, StableToken.ETL_ISEXECUTED+ isExecuted);
				fileWriter.write(map.get(StableToken.DNA_TOKEN_LOCK));
				fileWriterKey.write(map.get(StableToken.DNA_TOKEN_KEY));
